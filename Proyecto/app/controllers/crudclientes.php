...
function crudPostAlta(){
    ...
    $db = AccesoDatos::getModelo();
    if ( $db->addCliente($cli) && filter_var($_POST['ip_address'], FILTER_VALIDATE_IP) && validarEmail($_POST['email']) && validarTelefono($_POST['telefono'])) {
...
function crudPostModificar(){
    ...
    $cli->telefono      =$_POST['telefono'];
    $db = AccesoDatos::getModelo();
    if ( $db->modCliente($cli) && filter_var($_POST['ip_address'], FILTER_VALIDATE_IP) && validarEmail($_POST['email']) && validarTelefono($_POST['telefono'])){
